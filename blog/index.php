...
<title>示例</title></head>
<body>
<header><span id="title">博客系统</span>
<div id="user">你好！
<?php if(isset($_SESSION['username']))
{if (isset($_SESSION['status'])&&$_SESSION['status']=='管理员')
    echo "<a href='admin/admin.php'>";
else echo  "<a href='user/user.php'>";
echo $_SESSION['username']."</a>";

}else echo "请<a href=\"login.php\">登录</a>/<a href=\"2.php\">注册</a>";
    ?>
</div></header>
<nav>
