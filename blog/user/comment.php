...
<tr style="font-weight:bold;"><td  width="200">文章标题</td><td  width="200">留言内容</td><td width="100">留言时间</td></tr>
<?php
session_start();
$conn = mysqli_connect("localhost", "root", "19951219", "blog");
$sql = "select t1.*,t2.title as title from guestbook as t1 left join article as t2 on t1.art_id=t2.id where t1.username='".$_SESSION['username']."'";
