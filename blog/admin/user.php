...
function delet(id){
	if(confirm("确定删除？"))
	createRequest('operate.php?id='+id+'&target=user_del');
}
...
<table  border="1" style="padding-color:black;margin:auto;align:center">
<tr style="font-weight:bold;"><td  width="200">用户名</td></tr>
<?php
session_start();
